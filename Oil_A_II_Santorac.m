...
% set(gca,'ytick',0:0.02:0.12);
% axis([0 0.02 0 0.106])
title('Pure Rolling-Oil Santorac,U1=20.9 m/s,Pmax=2.36 GPa,Toil=80C, temperature effects included')
xlabel('Creeping Rate in %age (Cr) ');
ylabel('traction coefficient \mu');
%% OIl II 2.36 %*************************************************************
...
set(gca,'ytick',0:0.02:0.12);
axis([0 0.02 0 0.15]);
title('Pure Rolling, Oil A-II, U1=10 m/s,Pmax=3.5 Gpa,T=80')
xlabel('Creeping Rate in %age (Cr) ');
ylabel('traction coefficient \mu');
ylim([0 0.08])
...
set(gca,'ytick',0:0.02:0.12);
axis([0 0.02 0 0.15]);
title('Pure Rolling, Oil A-II, U1=10 m/s,Pmax=3.18 Gpa')
xlabel('Creeping Rate in %age (Cr) ');
ylabel('traction coefficient \mu');
xlim([0 0.014])
%% %% %% %*************************************************************
...
set(gca,'ytick',0:0.02:0.12);
axis([0 0.02 0 0.15]);
title('Pure Rolling, Oil A-II, U1=10 m/s,Pmax=2.3 Gpa,T=140')
xlabel('Creeping Rate in %age (Cr) ');
ylabel('traction coefficient \mu');
xlim([0 0.014])
%% 
